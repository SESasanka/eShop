                    ...
                    <div class="row">
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                WHERE `date` LIKE '%" . $today . "%' GROUP BY `product_id` ORDER BY `value_occurence` DESC LIMIT 1"); //ad dws thul wadiyen sell una product eka arn denv
                                ...
                                ?>
                                    <div class="col-12 text-center shadow">
                                        <img src="<?php echo $produc_data["img_path"]; ?>" class="img-fluid rounded-top" style="height: 250px;" />
                                    </div>
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center shadow">
                                        <img src="<?php echo $produc_data["path"]; ?>" class="img-fluid rounded-top" style="height: 250px;" />
                                    </div>
                                    <div class="col-12 text-center my-3">
                                        <span class="fs-5 fw-bold"><?php echo $produc_data["fname"]." ".$produc_data["lname"]; ?></span><br />
                                        <span class="fs-6"><?php echo $produc_data["email"]; ?></span><br />
                                        <span class="fs-6"><?php echo $produc_data["mobile"]; ?></span>
                                    </div>
                                <?php
                                } else {
                                ?>
